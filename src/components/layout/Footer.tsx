...
export default function Footer() {
  return (
    <footer
      ...
      style={{
        background: 'linear-gradient(180deg, #3A302B 0%, #352F2B 100%)',
      }}
    >
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row-reverse justify-between items-center px-12 gap-6">
        ...
        <div className="flex gap-8 text-sm text-warm-gray">
        ...
        <p className="text-warm-gray/60 text-xs">© {new Date().getFullYear()} Momento. כל הזכויות שמורות.</p>
      </div>
    </footer>
  )
}
